...
Outputs: tqbench/benchmarks/embeddings/data/chunk_samples/stratified_50k.parquet
"""
...
from tqbench.benchmarks.embeddings.eval.io_lance import read_prod_chunks
from tqbench.benchmarks.embeddings.eval.sampling import stratified_sample, SAMPLE_QUOTAS
