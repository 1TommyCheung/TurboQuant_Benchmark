...
Reads all reports/raw/*.json, computes weighted scores via eval.scoring,
...
from tqbench.benchmarks.embeddings.models import get_candidate, baseline_dim, load_registry
...
def main() -> None:
    ...
    # Scorecard table (uses correct math from eval.scoring: weighted_total includes dim penalty)
    scores_for_template = []
    for r in results:
